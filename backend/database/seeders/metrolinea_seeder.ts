...
export default class extends BaseSeeder {
  async run() {
    ...
    // 2. Create Stations
    const stationsData = [
      { name: 'Estación Provenza Occidental', location: 'Autopista Floridablanca (Costado Occidental)', occupancyLevel: 'HIGH', passengerCount: 120 },
      { name: 'Estación Provenza Oriental', location: 'Autopista Floridablanca (Costado Oriental)', occupancyLevel: 'MEDIUM', passengerCount: 65 },
      { name: 'Estación Diamante', location: 'Autopista Floridablanca - El Diamante', occupancyLevel: 'LOW', passengerCount: 20 },
      { name: 'Estación La Rosita', location: 'Diagonal 15 - Calle 45', occupancyLevel: 'HIGH', passengerCount: 95 },
      { name: 'Estación Chorreras', location: 'Carrera 15 - Calle 36', occupancyLevel: 'MEDIUM', passengerCount: 40 },
      { name: 'Estación Quebradaseca', location: 'Carrera 15 - Calle 30', occupancyLevel: 'LOW', passengerCount: 15 },
      { name: 'Estación UIS', location: 'Carrera 27 - Universidad Industrial de Santander', occupancyLevel: 'HIGH', passengerCount: 150 },
    ]
    ...
    // 5. Create Buses
    const busesData = [
      { plate: 'BUS-101', routeId: ptb.id, occupancyLevel: 'HIGH', passengerCount: 85, status: 'IN_TRANSIT' },
      { plate: 'BUS-102', routeId: ptb.id, occupancyLevel: 'LOW', passengerCount: 15, status: 'IN_TRANSIT' },
      { plate: 'BUS-201', routeId: t3.id, occupancyLevel: 'MEDIUM', passengerCount: 45, status: 'IN_TRANSIT' },
      { plate: 'BUS-202', routeId: t3.id, occupancyLevel: 'HIGH', passengerCount: 90, status: 'IN_TRANSIT' },
    ]
